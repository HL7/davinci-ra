...
<span class="bg-success" markdown="1">This IG also specifies a Task profile to support the workflow that enables the feedback loop from Provider and Risk Adjustment Coder back to the Payer after receiving the risk adjustment coding gap reports and conducting medical record review. This feedback loop is important for ahieving the goal of improving the accuracy and completeness of risk adjustment.

Lastly, we there is now a way a provider can annotate on the Risk Adjustment Gaps report that they took some action in regard to a specific gap on the report.</span><!-- new-content -->
