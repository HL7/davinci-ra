...
- Payer and Provider have established a contract for medical services.
...
-  Although the exact mechanisms for securing these exchanges are not specified as part of this implementation guide:
 ...
 - Payer and provider have agreed upon a process to identify specific patient(s).
...
Without the use of this FHIR Implementation Guide, providers likely receive Risk Adjustment Coding Gaps information in many ways.  The intent of the Guidance in this Implementation Guide is to unify how payers create these reports so there is less burden on the providers in addressing perceived gaps.  This structure also supports the payer sharing information that they have but the provider may not.
