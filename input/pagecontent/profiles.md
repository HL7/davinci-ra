...
The profile below is included in this implementation guide as a draft. It is a collection Bundle returned by the draft operation [$ra.evaluate-measure]. <!-- new-content --> 

- <span class="bg-success" markdown="1">[Risk Adjustment Coding Gap Report Bundle](StructureDefinition-ra-measurereport-bundle.html)<!-- new-content -->  
