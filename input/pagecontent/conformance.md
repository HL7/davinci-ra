...
The rules around mustSupport elements defined in [HRex](https://hl7.org/fhir/us/davinci-hrex/en/conformance.html#mustsupport) are also expected to apply to all Da Vinci implementation guides. 
